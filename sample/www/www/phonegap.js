...
/*
 * Set up mock.
 * This file is overwritten in build
 */
window.phonegapmock = true;
...
module.exports = {
    exec: function(service, action, callbackId, argsJson) {
        return false; //prompt(argsJson, 'gap:'+JSON.stringify([service, action, callbackId]));
    },
    setNativeToJsBridgeMode: function(value) {
        return false; ///prompt(value, 'gap_bridge_mode:');
    },
    retrieveJsMessages: function(fromOnlineEvent) {
        return false; //return prompt(+fromOnlineEvent, 'gap_poll:');
    }
};
